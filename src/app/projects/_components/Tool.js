import { Code2, Copy, DownloadIcon, Expand, Laptop, Smartphone } from 'lucide-react'
...
// This component was generated by SatPat Build.
// It uses the same Tailwind classes as the preview, so make sure Tailwind is enabled in your project.
const markup = \`${cleanCode}\`;

export default function SatpatPage() {
...
`
  ...
  return (
    <div className='flex w-full flex-wrap items-center justify-between gap-2 p-2.5 pb-0'>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuGroup>
              ...
              <DropdownMenuItem onClick={downloadReactComponent}>React component</DropdownMenuItem>
            </DropdownMenuGroup>
          </DropdownMenuContent>
        </DropdownMenu>
